...
```{r}
plot.igraph(g,layout=layout.lgl, edge.color=as.character(colsRB$colramp),edge.width=(E(g)$weight/50)) 
...
plot.igraph(g,layout=layout.auto, edge.color=as.character(colsRB$colramp),edge.width=(E(g)$weight/50)) 
