...
ggplot(out,aes(x=Beta,fill=combo)) + geom_histogram() + facet_wrap(~combo) + theme_bw() + ggtitle("Null Phylogenetic Betadiversity for Richness") + labs(col="Richness Combination",x="Phylogenetic Betadiversity")
```
